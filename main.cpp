...
// Interaction params
float MOUSE_STRENGTH_DISPLACEMENT = 500.0f; // strength & Distance of the 'pluck', initial value
int MOUSE_SIZE_THRESHOLD = 30; // size/rows/cols of the 'plucking' area, initial value
...
int main(int argc, char *argv[]) {
    ...
    SDL_Window *window = SDL_CreateWindow("Wave Harp", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WIDTH, HEIGHT, 0);
